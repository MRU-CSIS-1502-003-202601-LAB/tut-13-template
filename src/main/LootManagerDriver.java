...
public class LootManagerDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        // lootManager.add(LootFactory.create("Weapon,Pointy
        // Stick,Common,3".split(",")));
        // lootManager.add(LootFactory.create("Consumable,Bitter Little
        // Berries,Common,12".split(",")));
